...
/**
 * Палітра підложок буквених кружечків — ЕТАЛОННІ аватарні кольори Meet (точні hex
 * учасника; НЕ підбирати «на око»). Колір учасника призначає render.ts::assignAvatarColors:
 * бажаний колір — FNV-1a hash ІМЕНІ по палітрі, але в межах ОДНІЄЇ групи кольори
 * ДЕДУПЛІКУЮТЬСЯ (якщо бажаний зайнятий — детермінований зсув до наступного вільного).
 * Тож у групі до LETTER_COLORS.length (20) не-Sandro учасників усі кольори унікальні, а
 * «початок»/«кінець» і будь-який порядок (drag-and-drop) фарбують однаково (дедуп іде
 * за відсортованим іменем, не за позицією). Sandro (закріплена плитка) палітрою не
 * зачіпається — завжди #8d6e63; еталонний коричневий (#8c6d63, ≈ той самий) СВІДОМО
 * відсутній у пулі, щоб ніхто з решти не злився з кружечком Sandro. Порядок — як в
 * еталонній стрічці (мінус коричневий); з дедупом порядок впливає лише на напрям зсуву
 * при колізії, не на унікальність.
 */
