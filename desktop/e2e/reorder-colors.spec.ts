...
// Дві фічі: (1) колір буквеної аватарки — детермінована функція ІМЕНІ (однаковий
// на «початку»/«кінці», не міняється при пересортуванні); (2) drag-and-drop
// сортування рядків у таблиці учасників (ручка drag_indicator у колонці №).
